...
{	
	...
	double base1[3] = {1.0,0.0,0.0};

	double base2[3] = {1.0,1.0,0.0};
	double base3[3] = {0.0,0.0,1.0};
	...
	for(int k=0; k<kant; k++)
	{
		double gam = 1+2*k;
		double lambda = 0;
		lambda = LyapunovExponent(t_min, t_max, N, K, inicial, base1, gam);
		file1 << gam << " " << lambda << std::endl;
	}
	return 0;
